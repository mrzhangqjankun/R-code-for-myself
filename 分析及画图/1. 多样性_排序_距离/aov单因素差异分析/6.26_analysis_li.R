##6.26
#https://mp.weixin.qq.com/s/IGrj81ZzfEF8aXYIMhBh7A
#R语言一键批量完成差异统计和可视化 

getwd()
setwd("E:/桌面/R script 2017/WenTao/190521R_D/")
...
# 读入实验设计,只有这一个读入文件，改这个就行，后面应该都不用动。
data_wt = read.table("./cs.txt", header=T, sep="\t");head(data_wt)

##数据由长变宽
data_wt = dcast(data_wt,ID +group ~ grou, value.var = "count");?dcast #reshape2
#这里备注所需的数据格式
