...
rm(list=ls())
setwd("E:/桌面/R script 2017/数量生态学/数量生态学-R语言应用 数据和代码/赖江山/DATA")
...
#请观察多度频率分布柱状图，如何解读为什么0值（缺失）在数据框内频率这么高?
# 样方位置地图
# **************
...
# 将绘图窗口分割为4个绘图区域，每行两个
par(mfrow=c(2,2))
plot(spa, asp=1, col="brown", cex=spe$TRU, main="褐鳟", ##cex控制点的大小。这里气泡半径对应其多度。
	xlab="x坐标 (km)", ylab="y坐标 (km)")
lines(spa, col="light blue")
