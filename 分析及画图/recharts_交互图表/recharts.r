...
# 参数解析optparse、数据变换reshape2、绘图和开发包安装、安装依赖、ggplot主题
...
# 带有时间轴，时间为月，可播放的小动图，是不是B格满满：#t=Month,2s切换一次
...
# 可以调用低级函数setSeries来修改第二组，点大小为8，并旋转30度
...
# 修改图例(青柠色/绿黄色)，初始化时只选中第一系列(‘Automatic’)，可以手动选择
...
# 主要参考信息
# Chinese manual: http://madlogos.github.io/recharts/index_cn.html 
# R语言数据可视化---交互式图表recharts包 http://mp.weixin.qq.com/s/YqK5QvoGGtRxorWbV21D7g
